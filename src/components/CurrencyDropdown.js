...
const CurrencyDropdown = ({ currency, setCurrency,rates }) => {
    // console.log("currency",currency);
    const result = country_flag.find(item => item.code === currency);
    const flag = result ? result.flag : null;
    ...
    return (
        ...
        <div className="selected-currency">
            <img
              src={flag}
              alt={currency}
              style={{ width: '35px', height: '2.5rem', marginRight: '8px' }}
            />
        </div>
